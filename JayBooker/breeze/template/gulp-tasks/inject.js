...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('./*/pages/**/*.html', {
        ...
        .pipe(replace('href="documentation"', 'href="http://bootstrapdash.com/demo/breeze/jquery/documentation/documentation.html"'))
    ...
    var replacePath2 = gulp.src('./**/index.html', {
        ...
        .pipe(replace('src="assets/images/', 'src="../assets/images/'))
        .pipe(replace('href="documentation', 'href="http://www.bootstrapdash.com/demo/breeze/jquery/documentation/documentation.html"'))
        .pipe(gulp.dest('.'));
